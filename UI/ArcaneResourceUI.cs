...
namespace SpellbladeRevised.UI
{
    internal class ArcaneResourceUI : UIState
	{
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			if (Main.LocalPlayer.GetModPlayer<SpellbladePlayer>().arcanePowerCurrent <= 0 || !(Main.LocalPlayer.HeldItem.modItem is SpellbladeBase) || !(Main.LocalPlayer.HeldItem.modItem as SpellbladeBase).hasWeaponArt)
				return;
